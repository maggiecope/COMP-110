...
class Sloth(Critter):
    ...
    def __str__(self):
        return "S"
    def get_move(self, neighbors):
        if self.move_number % self.speed == 0:
            self.move_number+=1 
...
class ScaredCat(Critter):
    ...
    def __init__(self, location):
        super().__init__(location)
        self.dirs = [Direction.EAST,Direction.CENTER,Direction.NORTH, Direction.SOUTH, Direction.WEST]
        self.move_number = 0 
    ...
    def __str__(self):
        return "!"
    def get_move(self, neighbors):
        if neighbors[Direction.NORTH] == None:
            self.move_number+=1
            return Direction.NORTH
        elif neighbors[Direction.EAST] == None:
            self.move_number+=1
            return Direction.EAST
        elif neighbors[Direction.SOUTH] == None:
            self.move_number=+1
            return Direction.SOUTH
        elif neighbors[Direction.WEST] == None:
            self.move_number += 1
